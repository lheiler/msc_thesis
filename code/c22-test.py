...
# helper function to only extract values from catch22 features
...
raw = mne.io.read_raw_fif('/rds/general/user/lrh24/home/thesis/Datasets/tuh-eeg-ab-clean/eval/normal/aaaaaayx_s002_t000_eeg.fif', preload=True)

features_psd = extract_c22_psd(raw)

print(features_psd.shape)

features = extract_c22(raw)
