...
cd /rds/general/user/lrh24/home/thesis/code || {
  echo "❌ Could not cd to project root" >&2
  exit 1
}
...
#module load CUDA/12.1              # enable if GPU jobs
...
# ------------------------------------------------------------------
CONFIGS=(
  "bids_100_normal_abnormal_clean_ctm.yaml"
  "bids_100_normal_abnormal_clean_c22.yaml"
  "bids_100_normal_abnormal_clean_c22_psd.yaml"
  "bids_100_normal_abnormal_clean_AE.yaml"
  "bids_age_500_clean_ctm.yaml"
  "bids_age_500_clean_c22.yaml"
  "bids_age_500_clean_c22_psd.yaml"
