...
class Self_Supervised_Trainer(BaseTrainer):
    def __init__(self, *args, **kwargs):
        ...
        self.grad_accum_steps = int(kwargs.get('l2_reg', 1))  # temporary default; will be overwritten in train_epoch
    ...
    def train_epoch(self, epoch_num=None):
        ...
        self.grad_accum_steps = int(getattr(self, 'grad_accum_steps', 1))
        if hasattr(self, 'optimizer') and hasattr(self, 'loss_module'):
            self.grad_accum_steps = int(self.grad_accum_steps) if self.grad_accum_steps > 0 else 1
