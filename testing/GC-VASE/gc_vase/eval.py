...
if __name__ == '__main__':
    ...
    # Load state_dict, ignoring unexpected keys
    ...
    paradigm_wise_accuracies = test_results['XGB/test/task/paradigm_wise_accuracies']
    for i, acc in enumerate(paradigm_wise_accuracies):
        print(f"Paradigm {i + 1} Accuracy: {100 * acc:.2f}%")
